...
--
-- Anamakine: localhost
-- Üretim Zamanı: 23 Kas 2023, 21:40:11
...
CREATE TABLE `menu_items` (
  `meit_id` int UNSIGNED NOT NULL,
  `menu_id` int UNSIGNED NOT NULL,
  `term_id` int UNSIGNED DEFAULT '0',
  `meit_parent` int UNSIGNED NOT NULL DEFAULT '0',
  `meit_title` varchar(200) NOT NULL,
  `meit_path` varchar(250) DEFAULT NULL,
  `meit_order` int UNSIGNED NOT NULL DEFAULT '0',
  `meit_data` text
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
CREATE TABLE `terms` (
  ...
  `term_parent` int UNSIGNED NOT NULL DEFAULT '0',
...
--
ALTER TABLE `menus`
  MODIFY `menu_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- Tablo için AUTO_INCREMENT değeri `menu_items`
--
ALTER TABLE `menu_items`
  MODIFY `meit_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `post_term`
  MODIFY `pote_id` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `terms`
  MODIFY `term_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `post_term`
  ADD CONSTRAINT `post_term_ibfk_1` FOREIGN KEY (`term_id`) REFERENCES `terms` (`term_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `post_term_ibfk_2` FOREIGN KEY (`post_id`) REFERENCES `posts` (`post_id`) ON DELETE CASCADE;

--
-- Tablo kısıtlamaları `terms`
--
ALTER TABLE `terms`
  ADD CONSTRAINT `terms_ibfk_1` FOREIGN KEY (`tax_id`) REFERENCES `taxonomies` (`tax_id`) ON DELETE CASCADE;

--
-- Tablo kısıtlamaları `users_data`
--
ALTER TABLE `users_data`
  ADD CONSTRAINT `users_data_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE;
COMMIT;
